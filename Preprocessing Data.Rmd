...
## **Data**
The data used for this study was also used in Assignment 1 and is based on the Anime Dataset 2023, which sourced from the original data set "final_animedataset.csv" on Kaggle website which is located at <https://www.kaggle.com/datasets/dbdmobile/myanimelist-dataset>.  
